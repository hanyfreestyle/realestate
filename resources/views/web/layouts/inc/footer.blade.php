            ...
            <div class="row justify-content-md-center">
                <div class="col-md-6 col-xl-5">
                    <a href="{{route('page_index')}}" class="link d-inline-block mb-6">
                        <img src="{{getDefPhotoPath($DefPhotoList,'light-logo')}}" alt="image" class="img-fluid">
                    </a>
...
<div class="sticky-navbar fixed d-xl-none">
    <div class="sticky-info">
        <a href="index.php" class="active_footerX sticky_a ">
            <span class="material-symbols-outlined mat-icon"> home </span>
            Home
        </a>
    </div>
    <div class="sticky-info">
        <a href="Project.php" class="sticky_a ">
    ...
    <div class="sticky-info">
        <a href="List.php" class="sticky_a ">
            <span class="material-symbols-outlined mat-icon"> home </span>
            Units
        </a>
    </div>
