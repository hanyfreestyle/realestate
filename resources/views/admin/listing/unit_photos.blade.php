                        ...
                        @foreach($UnitPhotos as $Photo)
                            <div class="col-lg-2 ListThisItam"  data-index="{{$Photo->id}}" data-position="{{$Photo->postion}}" >
                                ...
                                <div class="buttons mb-3" >
                                    @can('unit_delete')
                                        <td class="tc"><x-action-button url="#" id="{{route('unit.More_PhotosDestroy',$Photo->id)}}"  type="deleteSweet"/></td>
                                    @endcan
                                </div>
                            </div>
                        @endforeach
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form  class="mainForm" action="{{route('unit.More_PhotosAdd')}}" method="post"  enctype="multipart/form-data">
                        @csrf
