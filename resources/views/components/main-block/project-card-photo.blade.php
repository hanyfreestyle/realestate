<div class="listing-card listing_card_relatedProjects">
    ...
    <div class="listing-card__content">
        <div class="d-flex align-items-center justify-content-end">
            <a href="#" class="link d-inline-block py-2 px-5 rounded-pill bg-tertiary-300 clr-neutral-900"> {{ getProjectStatus($project->status) }} </a>
        </div>
        <div class="listing-card__content-is">
            <div class="d-flex align-items-center justify-content-between mb-2">
                <span class="fs-14 fw-medium d-inline-block clr-neutral-0"> {{ getProjectTypeName($project->project_type)}} </span>
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between">
                ...
                <div class="d-flex align-items-centerX gap-2X">
                    ...
                    <a href="{{route('page_locationView',$project->locationName->slug)}}"><span class="clr-neutral-0">
                       {{$project->locationName->name}}
                    </span></a>
                </div>
                <div class="project_card_readmore ">
                    <a href="{{route('page_ListView',$project->slug)}}" class="btn btn-outline-secondary rounded-pill py-3 px-6 fw-semibold">{{ __('web/def.units-read-more')}} </a>
                </div>
            </div>
