    ...
    <div class="listing-card listing_card_relatedProjects">
        ...
        <div class="listing-card__content">
            <div class="d-flex align-items-center justify-content-end">
                <a href="#" class="link d-inline-block py-2 px-5 rounded-pill bg-tertiary-300 clr-neutral-900">
            ...
            <div class="listing-card__content-is">
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between">
                    ...
                    <div class="d-flex align-items-centerX gap-2X">
                        ...
                        <span class="clr-neutral-0 crop_locationName_card">
                            <a href="{{route('page_locationView',$project->locationName->slug)}}"  class="link clr-neutral-0"> {{$project->locationName->name}}</a>
                        </span>

                    </div>
                    <div class="project_card_readmore ">
                        <a href="{{route('page_ListView',$project->slug)}}" class="btn btn-outline-secondary rounded-pill py-3 px-6 fw-semibold">
